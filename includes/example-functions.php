...
function taskbook_register_demo_metabox() {
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'taskbook_demo_render_row_cb',
		'type' => 'text',
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'taskbook_demo_textdate_timestamp',
		'type' => 'text_date_timestamp',
		// 'timezone_meta_key' => 'taskbook_demo_timezone', // Optionally make this field honor the timezone selected in the select_timezone specified above
	) );

	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Date/Time Picker Combo (UNIX timestamp)', 'cmb2' ),
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'taskbook_demo_datetime_timestamp',
	...
	// 	'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
	// 	'id'   => 'taskbook_demo_datetime_timestamp_timezone',
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'taskbook_demo_textareasmall',
		'type' => 'textarea_small',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'taskbook_demo_textarea_code',
		'type' => 'textarea_code',
		// 'attributes' => array(
	...
	$cmb_demo->add_field( array(
		...
		'desc'     => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'       => 'taskbook_demo_text_taxonomy_radio',
	...
	$cmb_demo->add_field( array(
		...
		'desc'     => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'       => 'taskbook_demo_taxonomy_select',
	...
	$cmb_demo->add_field( array(
		...
		'desc'     => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'       => 'taskbook_demo_multitaxonomy',
	...
	$cmb_demo->add_field( array(
		...
		'desc'    => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'      => 'taskbook_demo_multicheckbox',
		'type'    => 'multicheck',
	...
	$cmb_demo->add_field( array(
		...
		'id'   => 'taskbook_demo_embed',
		'type' => 'oembed',
	) );

	$cmb_demo->add_field( array(
		'name'         => 'Testing Field Parameters',
		'id'           => 'taskbook_demo_parameters',
		'type'         => 'text',
...
function taskbook_register_repeatable_group_field_metabox() {
	...
	$cmb_group = new_cmb2_box( array(
		'id'           => 'taskbook_group_metabox',
		'title'        => esc_html__( 'Repeating Field Group', 'cmb2' ),
		'object_types' => array( 'page' ),
	) );

	// $group_field_id is the field id string, so in this case: 'taskbook_group_demo'
	$group_field_id = $cmb_group->add_field( array(
		'id'          => 'taskbook_group_demo',
		'type'        => 'group',
...
function taskbook_register_user_profile_metabox() {
	...
	$cmb_user->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'taskbook_user_googleplusurl',
		'type' => 'text_url',
	) );
	...
	$cmb_user->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'taskbook_user_user_text_field',
		'type' => 'text',
	) );
...
function taskbook_register_taxonomy_metabox() {
	...
	$cmb_term->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'taskbook_term_term_text_field',
		'type' => 'text',
	) );
...
function taskbook_register_rest_api_box() {
	...
	$cmb_rest->add_field( array(
		...
		'id'         => 'taskbook_rest_editable_text',
		'type'       => 'text',
